...
const PresidentSection = styled.section`
  background: rgba(255, 255, 255, 0.9);
  backdrop-filter: blur(10px);
  padding: 40px;
  border-radius: 20px;
  ...
  return (
    <Container>
      ...
      <main>
        ...
        <PresidentSection id="president">
          <h3>Message from Our Association President</h3>
          <PresidentCard>
            <PresidentPhoto src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR1wz0j6iNcsEAAUlxR1zS7jElJ8RnGj-74_w&s" />
      ...
      <Footer>© 2025 Sudanese Students in Rwanda. All rights reserved.</Footer>
    </Container>
  );
}
